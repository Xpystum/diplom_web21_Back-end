  @section('menu-header')
    <ul class="accordion" id="accordion">
        ...
        <li class="accordion-item">
            <h2 class="accordion-header">
                <button class="accordion-button collapsed @if(Request::url() == route('productsInReview') || Request::url() == route('productsApproved') || Request::url() == route('productsRejected')) active @endif" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
