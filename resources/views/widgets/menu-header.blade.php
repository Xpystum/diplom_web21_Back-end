    ...
    <ul>
        ...
        <li><a href="{{ route('test') }}" class="@if(Request::url() == route('test')) active @endif"><i class="fa-solid fa-boxes-packing"></i></i><span class="text-menu">Товары на проверке</span></a></li>
        ...
        <li><a href="{{ route('test') }}" class="@if(Request::url() == route('test')) active @endif"><i class="fa-solid fa-comment"></i><span class="text-menu">Комментарии</span></a></li>
        <li><a href="{{ route('test') }}" class="@if(Request::url() == route('test')) active @endif"><i class="fa-solid fa-pen-ruler"></i><span class="text-menu">123</span></a></li>
        <li><a href="{{ route('test') }}" class="@if(Request::url() == route('test')) active @endif"><i class="fa-solid fa-user-pen"></i><span class="text-menu">Клиенты</span></a></li>
    </ul>
