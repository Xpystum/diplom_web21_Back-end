...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('products', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('brand_id')->comment('id Бренда')->nullable();
            $table->unsignedBigInteger('model_id')->comment('id Модели')->nullable();
            $table->unsignedBigInteger('color_id')->comment('id Цвета')->nullable();
            ...
            $table->unsignedInteger('mileage')->comment('Пробег')->nullable();
            
            
            $table->string('additional')->comment('Дополнительно')->nullable();
            $table->string('city')->comment('город продажи')->nullable();
            ...
            $table->text('desription')->comment('описание')->nullable();
